function plot_result_continuous(TY,Y,K,TXF,XF,av,T_filter,filter_true,filter_true2,filter_approximate,filter_approximate2)
...
ylabel({'Accumulative'; 'observations'},'FontSize',font_size)
...
hold on
approximate_filter_plot=plot(T_filter, 5*N*filter_approximate(9,:),'b','LineWidth',1);
hold on
...
bayesian_estimation=plot(T_filter, N*sqrt(variance1),'r','LineWidth',1);
hold on
approximate_filter_plot=plot(T_filter, N*sqrt(variance2),'b','LineWidth',1);
hold on
