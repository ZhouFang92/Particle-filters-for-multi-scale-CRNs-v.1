...
%% Generate a reference process and observation (It may take several minuts)
tic
...
tic
 [T_filter_continuous,filter_continuous_FM, filterSD_continuous_FM]= particle_filter_full_model_continuous_time(TYC, YC, M, 0.5);
time_cf=toc;
...
tic
[T_filter_continuous,filter_continuous_RM, filterSD_continuous_RM]= particle_filter_reduced_model_continuous_time(TYC, YC, M, 0.5);
time_cr=toc;
