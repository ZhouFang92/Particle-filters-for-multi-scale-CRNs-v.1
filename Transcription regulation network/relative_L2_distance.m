...
delta=mean1-mean2;
distance(1,1)=sqrt(sum(delta.^2))/sqrt(sum(mean1.^2));
...
distance(1,2)=sqrt(sum(delta.^2))/sqrt(sum(variance1));
...
mean2=filter2(11,:);
delta=mean1-mean2;
distance(2,1)=sqrt(sum(delta.^2))/sqrt(sum(mean1.^2));

variance1=filter1SD(11,:);
variance2=filter2SD(11,:);
delta=sqrt(variance1)-sqrt(variance2);
distance(2,2)=sqrt(sum(delta.^2))/sqrt(sum(variance1));
...
mean2=filter2(13,:);
delta=mean1-mean2;
distance(3,1)=sqrt(sum(delta.^2))/sqrt(sum(mean1.^2));
variance1=filter1SD(13,:);
variance2=filter2SD(13,:);
delta=sqrt(variance1)-sqrt(variance2);
distance(3,2)=sqrt(sum(delta.^2))/sqrt(sum(variance1));
